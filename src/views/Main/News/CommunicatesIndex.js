...
class CommunicatesIndex extends Component {
    state = {
        pages: null,
        news: [],
    };
    ...
    render() {
        ...
        return (
            <>
                <Helmet>
                    <title>Komunikaty - Oficjalny Portal Gminy Jarocin</title>
                    <meta
                        name="description"
                        content="Komunikaty - bądź na bieżąco z tym co dzieje się wokół Ciebie, śledź komunikaty!"
                    />
                </Helmet>
                <LayoutCardWithTitleAndPath
                    pathItems={[
                        { url: '/', label: 'Strona główna' },
                        { url: '/komunikaty', label: 'Komunikaty' },
                    ]}
                    category="Komunikaty"
                    title="Komunikaty"
...
export default CommunicatesIndex;
/*
